...
public interface TypeExpressionListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link TypeExpressionParser#inicio}.
	 * @param ctx the parse tree
	 */
	void enterInicio(TypeExpressionParser.InicioContext ctx);
	/**
	 * Exit a parse tree produced by {@link TypeExpressionParser#inicio}.
	 * @param ctx the parse tree
	 */
	void exitInicio(TypeExpressionParser.InicioContext ctx);
	/**
	 * Enter a parse tree produced by {@link TypeExpressionParser#fim}.
	 * @param ctx the parse tree
	 */
	void enterFim(TypeExpressionParser.FimContext ctx);
	/**
	 * Exit a parse tree produced by {@link TypeExpressionParser#fim}.
	 * @param ctx the parse tree
	 */
	void exitFim(TypeExpressionParser.FimContext ctx);
	/**
