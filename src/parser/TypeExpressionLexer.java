...
public class TypeExpressionLexer extends Lexer {
	...
	public static final int
		...
		MUL=18, DIV=19, OPREL=20, ID=21, VIRG=22, PF=23, AP=24, FP=25, ACO=26, 
		FCO=27, BLANK=28;
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__9", "T__10", "T__11", "NUMBER", "TEXT", "ATTR", "SUM", "SUB", "MUL", 
			"DIV", "OPREL", "ID", "VIRG", "PF", "AP", "FP", "ACO", "FCO", "BLANK"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, "NUMBER", "TEXT", "ATTR", "SUM", "SUB", "MUL", "DIV", "OPREL", 
